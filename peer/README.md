...
This folder is a kit copy of `device stuff/main-openmicro-peer/`. Day-to-day RTT
bring-up (no main flash) uses the kit launcher — see
[`../README.md`](../README.md).
...
```text
1. fw flash openmicro          # display
2. node dist/cli.js --freewili --no-hid claude
3. fw rtt                      # OpenOCD RTT :9090
4. npm run bridge:rtt          # in demo_inspo/OpenMicro
```
